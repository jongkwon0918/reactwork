...
//styled-Components라이브러리 이용해서 스타일 적용된 컴포넌트 이용하기
import styled from "styled-components";
import D_StyledComponentProps from "./D_StyledComponentProps";
import E_TailWindContainer from "./tailwind/E_TailWindContainer";
...
export default function C_styledComponent() {
  return (
    <div>
      <h2>styled-Component를 이용하기</h2>
      <Container>styled.div</Container>
      <Title>나는 제목이야</Title>
      <Container>
        <Title>여러분 힘내요! 프론트가 싫어요!</Title>
      </Container>
      <ContainerRight>
