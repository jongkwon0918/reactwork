...
export default function B_Usejavascript() {
  ...
  const name = "jklove";
  let age = 20;
  const height = [180.5, 194.3, 175.2, 166.8];
  const person = {
    name: "박종권",
    age: 26,
    address: "창원시 가음정동",
  ...
  const students = [
    { name: "김태우", grade: 1, classNum: 2, gender: "남" },
    { name: "전재우", grade: 2, classNum: 3, gender: "여" },
    { name: "신동호", grade: 3, classNum: 4, gender: "남" },
  ];
  return (
    <div>
      <h2>변수 출력하기</h2>
